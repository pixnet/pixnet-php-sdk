...
$examples_list = array(
    ...
    '相簿' => array(
        ...
        array(
            'name' => '相片留言',
            'examples' => array(
                '取得相片上單一留言' => '450_album_elements_comments_search.php',
        ...
        array(
            'name' => '相簿留言',
            'examples' => array(
                '取得相簿留言' => '460_album_comments_search.php',
                '新增相簿留言' => '461_album_comments_create.php',
                '讀取單一留言' => '462_album_comments_search.php',
                '將留言設為廣告留言' => '463_album_comments_markspam.php',
                '將留言設為非廣告留言' => '464_album_comments_unmarkspam.php',
                '刪除相簿留言' => '465_album_comments_delete.php',
            )
        ),
        array(
            'name' => '人臉標記',
