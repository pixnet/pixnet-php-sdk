...
<div class="container">
    ...
    <h3>呼叫方式</h3>
    <pre>$pixapi->album->elements->comments->markHam($comment_id);</pre>
    <div class="well">
        <p>必填參數</p>
        <ul>
            <li>
    ...
    <h3>實際執行</h3>
    <pre>
        $pixapi->album->elements->comments->markHam('<?= $_POST['comment_id'] ?>')
    </pre>
    <h3>執行結果</h3>
    <pre><?php print_r($pixapi->album->elements->comments->markHam($_POST['comment_id'])); ?></pre>
    <?php }?>
</div>
</body>
</html>
