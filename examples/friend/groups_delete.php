...
$query = $_POST['query'];
if ('' != $query) {
  $response = $pixapi->friend->groups->delete($query);
}
?>
<!DOCTYPE html>
<html>
...
<div class="container">
    ...
    <h1 class="page-header">刪除好友群組</h1>
    <h3>呼叫方式</h3>
    <pre>$pixapi->friend->groups->delete($id);</pre>
    <div class="well">
        <p>必填參數</p>
        <ul>
    ...
    ?>
    <h3>執行</h3>
    <pre>$pixapi->friend->groups->delete(<?= $query; ?>);</pre>
    <h3>執行結果</h3>
